...
const Navbar = () => {
  ...
  const renderDesktopAuthButton = () => {
    return isAuthenticated ? (
      <button
        ...
        className="px-3 lg:px-4 py-1.5 lg:py-2 bg-gradient-to-br from-red-500 to-emerald-700 text-[#2D1B0E] 
      ...
      <button
        ...
        className="px-3 lg:px-4 py-1.5 lg:py-2 bg-gradient-to-br from-red-400 to-emerald-600 text-[#2D1B0E] 
  ...
  const renderMobileAuthButton = () => {
    return isAuthenticated ? (
      <button
        onClick={handleLogout}
        className="w-full px-4 py-3 bg-gradient-to-br from-red-500 to-emerald-700 text-[#2D1B0E] rounded-xl font-semibold flex items-center justify-center space-x-2"
      >
  ...
  return (
    <nav className="bg-[#2D1B0E] border-b-8 border-rose-900/40 shadow-[0_25px_50px_-12px] shadow-amber-900/30 sticky top-0 z-50 font-vibes">
      <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-full max-w-7xl px-4">
        <div className="h-[6px] bg-gradient-to-r from-transparent via-rose-600/50 to-transparent shadow-[0_0_20px] shadow-amber-500/30"></div>
        ...
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="flex-shrink-0 flex items-center space-x-2 group">
            ...
            <div className="flex flex-col ml-1 md:ml-2">
              <NavLink
                to="/"
                className="text-lg md:text-xl lg:text-2xl xl:text-3xl bg-gradient-to-r from-rose-400 to-teal-600 bg-clip-text text-transparent font-monsieur tracking-wider whitespace-nowrap"
              >
                Bite-Buzz
              </NavLink>
              <div className="h-[3px] bg-gradient-to-r from-rose-600/30 via-teal-400/50 to-amber-600/30 w-full mt-1" />
            </div>
          </div>
