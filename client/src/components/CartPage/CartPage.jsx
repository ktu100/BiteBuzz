    ...
    <div className="min-h-screen overflow-x-hidden py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d]">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-12">
          <span className="font-dancingscript block text-5xl sm:text-6xl md:text-7xl mb-2 bg-gradient-to-r from-rose-200 to-rose-400 bg-clip-text text-transparent">
            Your Cart
          </span>
        </h1>
        ...
        {cartItems.length === 0 ? (
          <div className="text-center">
            <p className="text-rose-100/80 text-xl mb-4">Your cart is empty</p>
            <Link
              to="/menu"
              className="bg-rose-900/40 px-6 py-2 rounded-full font-cinzel text-sm uppercase hover:bg-amber-800/50 transition duration-300 text-amber-100 inline-flex items-center gap-2"
            >
              Browse All Items
            </Link>
          </div>
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {cartItems
                ...
                .map(({ _id, item, quantity }) => (
                  <div
                    key={_id}
                    className="group bg-amber-900/20 p-4 rounded-2xl border-4 border-dashed border-rose-500 backdrop-blur-sm flex flex-col items-center gap-4 transition-all duration-300 hover:border-solid hover:shadow-xl hover:shadow-amber-900/10 transform hover:-translate-y-1"
                  >
                    <div
                    ...
                    <div className="w-full text-center">
                      <h3 className="text-xl font-dancingscript text-rose-100">
                        {item.name}
                      </h3>
                      <p className="text-rose-100/80 font-cinzel mt-1">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-8 h-8 rounded-full bg-rose-900/40 flex items-center justify-center hover:bg-amber-800/50 transition duration-200 active:scale-95"
                      >
                        <FaMinus className="w-4 h-4 text-rose-100" />
                      </button>
                      <span className="w-8 text-center text-rose-100 font-cinzel">
                        {quantity}
                      </span>
                      <button
                      ...
                      >
                        <FaPlus className="w-4 h-4 text-rose-100" />
                      </button>
                    </div>
                    ...
                    <div className="flex items-center justify-between w-full">
                      ...
                      <p className="text-sm font-dancingscript text-rose-300">
            ...
            <div className="mt-12 pt-8 border-t border-rose-800/30">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-8">
                ...
                <div className="flex items-center gap-8">
                  <h2 className="text-3xl font-dancingscript text-rose-100">
