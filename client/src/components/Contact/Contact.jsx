...
import { FiMapPin, FiPhone, FiMail, FiMessageSquare, FiGlobe, FiSmartphone, FiHome, FiArrowRight, FiUser } from 'react-icons/fi';
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappNumber = '917627047536';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-900 via-rose-900 to-green-900 animate-gradient-x py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 font-[Poppins] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-8 animate-fade-in-down">
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-400 to-orange-300">
            Connect With Us
          </span>
        </h1>
          ...
          <div className="space-y-6">
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-amber-500 hover:border-amber-400 group">
              ...
              <div className="flex items-center mb-4 relative z-10">
                <div className="p-3 bg-gradient-to-br from-rose-500/30 to-rose-700/30 rounded-xl">
                  <FiMapPin className="text-rose-400 text-2xl animate-pulse" />
                </div>
                <h3 className="ml-4 text-amber-100 text-xl font-semibold">Our Headquarter</h3>
              </div>
              <div className="pl-12 relative z-10">
                <p className="text-rose-100 font-light text-lg">Rudra Vihar,Pratap Nagar,Udaipir-313001</p>
              </div>
            </div>
